package com.gneo.fgurbanov.junctionhealth.presentation.old;
...
public class OldActivity extends AppCompatActivity implements AdapterView.OnItemLongClickListener, AdapterView.OnItemClickListener  {
    private static final String LOG_TAG = OldActivity.class.getSimpleName();
